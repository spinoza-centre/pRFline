...
latex_documents = [
    (master_doc, 'pRFline.tex', 'pRFline Documentation',
     'Jurjen Heij', 'manual'),
]
...
man_pages = [
    (master_doc, 'pRFline', 'pRFline Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'pRFline', 'pRFline Documentation',
     author, 'pRFline', 'pRF-experiments using ultrahigh spatiotemporal resolution linescanning fMRI',
     'Miscellaneous'),
]
